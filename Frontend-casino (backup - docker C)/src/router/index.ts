...
// 👇 IMPORT DAS TELAS INFORMATIVAS 👇
import Politica from '../components/Politica.vue';
import Regras from '../components/Regras.vue';
import JogoResponsavel from '../components/JogoResponsavel.vue';
...
const routes = [
  ...
  // 👇 ROTAS DE INFORMAÇÕES (Agora Política aceita aba dinâmica) 👇
  { path: '/politica/:aba?', name: 'Politica', component: Politica },
  { path: '/regras/:jogo?', name: 'Regras', component: Regras },
  { path: '/jogo-responsavel', name: 'JogoResponsavel', component: JogoResponsavel },
