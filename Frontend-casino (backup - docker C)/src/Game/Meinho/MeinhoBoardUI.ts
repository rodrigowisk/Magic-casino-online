...
export class MeinhoBoardUI {
    ...
    private buildBoard() {
        ...
        blurFilter.quality = 1; // 🔥 OTIMIZAÇÃO DE GPU: Qualidade 1 (o padrão é 4) anula o lag brutal dos borrões
        blurFilter.resolution = 0.5; // 🔥 Renderiza o filtro na metade da resolução 
