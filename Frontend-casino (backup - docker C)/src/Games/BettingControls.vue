<template>
  <div class="player-controls">
    ...
    <div class="action-buttons">
      <button class="skip-btn" @click="acionarPular">PULAR</button>

      <button class="confirm-bet-btn" @click="acionarApostar">
...
const setExactValue = (val: number) => {
  // 🔥 Feedback tátil rápido ao tocar nos valores mínimo/máximo
  hapticsService.lightImpact(); 
  
  localBetAmount.value = val;
};

// 👇 Funções intermediárias para disparar a vibração antes de avisar a mesa
const acionarPular = () => {
  hapticsService.lightImpact(); // Feedback de botão clicado
  emit('pular');
};

const acionarApostar = () => {
  hapticsService.lightImpact(); // Feedback de botão clicado
